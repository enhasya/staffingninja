    ...
    <div className="bg-[#ffffff] flex flex-col gap-8 lg:gap-16 items-start lg:items-center justify-center w-full h-auto lg:h-auto p-8 lg:p-32">
      <section className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start lg:items-center justify-center w-full lg:w-auto">
        <div className="flex flex-col w-full lg:w-[640px]">
          ...
          <p className="text-[#2c3640]/60 text-sm lg:text-lg font-medium tracking-tight leading-relaxed lg:leading-relaxed w-full mt-4 lg:mt-8">
        ...
        <div className="flex flex-col gap-8 justify-center w-full mt-0">
          <div className="grid grid-cols-3 lg:grid-cols-5 gap-8 w-full h-auto">
            <div className="flex flex-col gap-0 items-center justify-center w-full p-4 lg:p-8 ring-1 ring-black/5 shadow-2xl transition-all shadow-black/10 lg:hover:shadow-black/20 rounded-lg">
